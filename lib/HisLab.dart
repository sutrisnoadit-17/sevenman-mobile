...
class Hlab extends StatefulWidget {
  const Hlab({super.key});

  @override
  State<Hlab> createState() => _HlabState();
}

class _HlabState extends State<Hlab> {
  bool _saving = false;
  String idSelected = "";
  Uri apiUrl = Uri.parse("https://api.bukan-web.xyz/api/sevenman/history/lab");

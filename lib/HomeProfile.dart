...
class _TamProfilState extends State<TamProfil> {
  ...
  Widget build(BuildContext context) {
    var roundedRectangleBorder = RoundedRectangleBorder(borderRadius: BorderRadius.circular(15));
    return  Scaffold(
      body: Padding(
              ...
              child: TextButton(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Expanded(
                      child: Text("History", style: TextStyle(color: fcolor),)
                    ),
              ...
              child: TextButton(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Expanded(
                      child: Text("Bantuan & Dukungan", style: TextStyle(color: fcolor),)
                    ),
                    Icon(Icons.arrow_forward_ios),
                  ],
                ),
              ...
              child: TextButton(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Expanded(
                      child: Text("Tentang App", style: TextStyle(color: fcolor),)
                    ),
                    Icon(Icons.arrow_forward_ios),
                  ],
                ),
              ...
              child: TextButton(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10,),
                    Expanded(
                      child: Text("Log Out", style: TextStyle(color: fcolor),)
                    ),
                    Icon(Icons.arrow_forward_ios),
                  ],
                ),
